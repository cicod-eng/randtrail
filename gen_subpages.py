#!/usr/bin/env python3
"""Generate the 12 lightweight sub-hub pages (kills the nav/footer 404s).

Reuses gen.py's header/footer/write_page so the chrome stays consistent.
Run:  python3 gen_subpages.py

Note: five pages have been manually expanded into full guides and are now
hand-maintained (NOT generated here, so regenerating does not overwrite them):
  buy-sell/p2p, tax-regulation/sars, wallets-safety/account-security,
  wallets-safety/scam-prevention, wallets-safety/transfers-networks.
"""
...
page("buy-sell/sell-crypto/index.html", "Buy & Sell", "Buy &amp; Sell", "Sell Crypto",
    ...
    <p>Before selling, confirm how the money will reach you. A <a href="../withdrawals/">ZAR withdrawal to a South African bank account</a> is one route; P2P is another, where the buyer pays you directly. Each has different timing and fees, so check the amount you will actually receive before you confirm.</p>
    <h2>Related guides</h2>
    <ul>
...
# buy-sell/p2p — hand-maintained full guide (not generated); left out to avoid overwriting it.
...
# wallets-safety/account-security — hand-maintained full guide (not generated); left out to avoid overwriting it.
# wallets-safety/transfers-networks — hand-maintained full guide (not generated); left out to avoid overwriting it.
# wallets-safety/scam-prevention — hand-maintained full guide (not generated); left out to avoid overwriting it.

# ---- Tax & Regulation ----

# tax-regulation/sars — hand-maintained full guide (not generated); left out to avoid overwriting it.
